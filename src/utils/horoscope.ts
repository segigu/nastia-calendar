...
- Не придумывай новых родственников и детей — достаточно Насти, Серёжи и их бытовых миссий.
...
- subtitle — одно плотное предложение (до 22 слов), где с лёгким сарказмом подмечают, что Серёжа снова мутит что-то; никаких клише вроде «гороскоп всё расскажет», «узнаем правду» и т.п.
...
- Подзаголовок должен явно намекать, что речь про сегодняшний день, но без банальных обещаний про «гороскоп расскажет».
