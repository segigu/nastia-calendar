...
ВАЖНО — РАЗНООБРАЗИЕ СЦЕНАРИЕВ:
Каждая история должна начинаться в РАЗНОЙ локации и ситуации. НЕ повторяй одни и те же места.
Варьируй:
- Локации: улица ночью, офис на последнем этаже, лес на рассвете, пустая станция метро, чужая квартира, крыша дома, заброшенное здание, парк зимой, берег моря, закрытый музей, больничный коридор, автобус в пригород, подвал старого дома, книжный магазин после закрытия, мост над рекой, чердак с забытыми вещами
- Время суток: рассвет, полдень, сумерки, глубокая ночь, золотой час
- Погода: туман, дождь, снег, жара, холод, ветер, тишина
- Ситуации: просыпаешься в незнакомом месте, ждёшь кого-то, убегаешь от чего-то, возвращаешься после долгого отсутствия, находишь странный предмет, слышишь непонятный звук, встречаешь загадочного человека

Выбери СЛУЧАЙНУЮ комбинацию локации, времени и ситуации, которая соответствует жанру и натальной карте.
...
${currentArc === 1 ? 'ОБЯЗАТЕЛЬНО создай УНИКАЛЬНУЮ начальную локацию и ситуацию (смотри список выше). НЕ используй стандартные клише типа "чужая квартира у окна". Выбери неожиданное место и ситуацию, соответствующие жанру.' : ''}
${choiceInstruction}
${contractInstruction}
