...
Ситуация: сегодня овуляция. Прямо и резко скажи про пик фертильности и что без контрацепции — играешь с огнём. Не больше 55 символов!`;
    case 'period_forecast':
      return `${base}
Ситуация: до менструации ${Math.abs(context.daysUntilPeriod)} ${context.daysWord}. Жёстко, но по-сестрински: напомни, что шторм на подходе. ВАРЬИРУЙ совет каждый раз (грелка, шоколад, терпение, запасы, отдых, спокойствие - чередуй!). Максимум 55 символов!`;
    case 'period_check':
    case 'period_start':
      return `${base}
